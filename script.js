document.addEventListener("DOMContentLoaded", () => {
    ...
    newChatBtn.addEventListener("click", () => {
        ...
        promptInput.focus();
        closeSidebar(); // Close sidebar on mobile after starting a new chat
    });
    ...
    // Use a single function to toggle both the sidebar and the body class
    ...
    // Add event listener to detect when a user clicks the sidebar itself, stopping propagation of the close event
